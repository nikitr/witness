...
- (void)viewDidLoad {
    ...
    _toolbar.barTintColor = [UIColor colorWithRed:135/255. green:110/255. blue:159/255. alpha:1];
...
- (void)performLayout {
    ...
    if ([self.navigationController.viewControllers objectAtIndex:0] == self) {
        ...
        UIImage *image1 = [UIImage imageNamed:@"savebar"];

        _doneButton = [[UIBarButtonItem alloc] initWithImage:image1 style:UIBarButtonItemStylePlain target:self action:@selector(doneButtonPressed:)];
        _reportButton = [[UIBarButtonItem alloc] initWithImage:image style:UIBarButtonItemStylePlain target:self action:@selector(doneButtonPressed:)];
        // Set appearance
        ...
        self.navigationItem.leftBarButtonItem = _reportButton;
    } else {
...
- (void)setNavBarAppearance:(BOOL)animated {
    ...
    navBar.barTintColor = [UIColor colorWithRed:135/255. green:110/255. blue:159/255. alpha:1];
...
- (CGRect)frameForSelectedButton:(UIButton *)selectedButton atIndex:(NSUInteger)index {
    ...
    CGRect selectedButtonFrame = CGRectMake(pageFrame.origin.x + pageFrame.size.width/2 - selectedButton.frame.size.width/2,
        pageFrame.origin.y + pageFrame.size.height - selectedButton.frame.size.height - padding - yOffset - 15,
